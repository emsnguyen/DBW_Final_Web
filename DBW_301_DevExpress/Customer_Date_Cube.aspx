        ...
        <div>
            <dx:ASPxPivotGrid ID="ASPxPivotGrid1" runat="server" ClientIDMode="AutoID" OLAPConnectionString="provider=MSOLAP;data source=localhost;initial catalog=DBW_Final_SASS_Updated;cube name=Customer_Date_Cube">
                <Fields>
                    ...
                    <dx:PivotGridField ID="fieldFullName" Area="ColumnArea" AreaIndex="1" Caption="Full Name" FieldName="[Dim Customer].[Customer_Type_Name_Hierarcy].[Full Name]" GroupIndex="0" InnerGroupIndex="1" Name="fieldFullName">
                    </dx:PivotGridField>
